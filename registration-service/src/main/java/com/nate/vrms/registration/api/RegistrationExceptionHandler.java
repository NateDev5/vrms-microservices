...
import com.nate.vrms.registration.application.exception.*;
import com.nate.vrms.registration.application.exception.CrossContextValidationException;
import com.nate.vrms.registration.application.exception.PlateAlreadyTakenException;
import com.nate.vrms.registration.application.exception.RegistrationNotFoundException;
import com.nate.vrms.registration.domain.exception.*;
import com.nate.vrms.registration.domain.exception.ExpiryDateMustBeFutureException;
import com.nate.vrms.registration.domain.exception.InvalidPlateException;
import com.nate.vrms.registration.web.ApiErrorResponse;
