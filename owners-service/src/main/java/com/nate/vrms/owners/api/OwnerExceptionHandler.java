package com.nate.vrms.owners.api;

import com.nate.vrms.owners.application.exception.*;
import com.nate.vrms.owners.application.exception.DuplicateOwnerException;
import com.nate.vrms.owners.application.exception.OwnerNotFoundException;
import com.nate.vrms.owners.domain.exception.*;
import com.nate.vrms.owners.domain.exception.InvalidAddressException;
import com.nate.vrms.owners.domain.exception.InvalidOwnerNameException;
import com.nate.vrms.owners.web.ApiErrorResponse;
